...
class DepenseController extends AbstractController
{
     ...
     */
    public function new(Request $request, CategorieRepository $categorieRepository, AnneeRepository $anneeRepository): Response
    {
        $depense = new Depense();
        $form = $this->createForm(DepenseType::class, $depense);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $depense->setAnnee($anneeRepository->findOneBy(['isEnCours'=>true]));
            $depense->setCategorie($categorieRepository->find(1));
